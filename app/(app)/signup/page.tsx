        ...
        <div className="flex flex-col min-h-screen bg-[#0D0D0D] text-[#e5e2e1] font-sans selection:bg-[#f08c00]/30 selection:text-white">
            ...
            <main className="flex-grow flex items-center justify-center px-6 pt-24 pb-16 relative overflow-hidden">
                ...
                <div ref={cardRef} className="industrial-card w-full max-w-[440px] p-10 rounded-lg z-10 transition-transform duration-200 ease-out" style={{ transform: 'perspective(1000px) rotateX(0deg) rotateY(0deg)' }}>
                    <Link href="/" className="absolute top-4 left-4 text-[#888888] hover:text-[#f08c00] transition-colors flex items-center justify-center w-8 h-8 rounded hover:bg-[#2A2A2A] group" title="Return to Home">
                    ...
                    <div className="flex flex-col items-center text-center mb-10">
                        ...
                        <h1 className="font-serif text-2xl text-[#e5e2e1] mb-2 font-bold">Initialize Workspace</h1>
                        <p className="font-mono text-xs text-[#b7b5b4] opacity-80 uppercase tracking-widest">Register your engineering profile</p>
                    </div>

                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                        <div className="space-y-2">
                            <label className="font-mono text-xs text-[#b7b5b4] flex items-center gap-2 uppercase tracking-widest" htmlFor="username">
                    ...
                    <div className="mt-8 flex items-center gap-4">
                        ...
                        <span className="font-mono text-[10px] text-[#554334] tracking-widest uppercase">OR</span>
                        <div className="h-px bg-[#2A2A2A] flex-1"></div>
                    </div>
                    ...
                    <button
                        ...
                        className="w-full mt-8 py-3.5 px-6 rounded-lg font-sans text-sm font-semibold text-[#e5e2e1] bg-[#121212] border border-[#2A2A2A] hover:bg-[#1c1b1b] transition-all flex items-center justify-center gap-3 micro-shadow"
                    >
                    ...
                    <div className="mt-8 pt-6 border-t border-[#2A2A2A] text-center">
                        <p className="font-mono text-xs text-[#b7b5b4] uppercase tracking-widest">
                            ...
                            <Link href="/signin" className="text-[#F08C00] font-bold hover:underline ml-2">Log in</Link>
                        </p>
                    </div>
                </div>
